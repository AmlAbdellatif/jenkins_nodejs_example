    ...
    stages {
        stage('CI') {
            steps {
               ...
               docker login  -u ${nexus_username} -p ${nexus_pass} 10.108.235.232:8801/repository/docker-repo/
               docker tag nodejsapp:latest 10.108.235.232:8801/repository/docker-repo/nodejsapp:latest
